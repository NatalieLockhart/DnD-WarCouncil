...
describe('dice', function (){
	it('should return a random number between 1 and 20', function () {
	...
	it('should return a random number between 1 and 8', function () {
...
describe('dice.diceParser(diceType)', function (){
	it('should return a random number between 1 and 10 when given the number 10', function () {
		expect(dice.rollD10()).to.be.greaterThan(0).and.lessThan(11);	
	});
	
	it('should return a random number between 1 and 4 if an invalid number is passed', function () {
		expect(dice.rollD4()).to.be.greaterThan(0).and.lessThan(5);
	});
});